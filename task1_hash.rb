class Myproduct
	...
	def electronics_product()
		...
		case @item_number.to_i
			when 1
				...
				@@bill << { i_category: "ELECTRONICS", item_name: "TV", item_quantity: @item_quantity, item_amount:@item_amount}
			...
			when 2
				...
				@@bill << { i_category: "ELECTRONICS", item_name: "Mobile", item_quantity: @item_quantity, item_amount:@item_amount}
			...
			when 3
				...
				@@bill << { i_category: "ELECTRONICS", item_name: "Oven", item_quantity: @item_quantity, item_amount:@item_amount}
	...
	def toys_product()
		...
		case @item_number.to_i
			when 1
				...
				@@bill << { i_category: "Toys",item_name: "Teddy bear", item_quantity: @item_quantity,item_amount:@item_amount}
				
			when 2
				@@total_amount+=350*@item_quantity
   				@item_amount=350*@item_quantity
				puts "Your total amount for Car is: "+@item_amount.to_s
				@@bill << { i_category: "Toys",item_name: "car", item_quantity: @item_quantity,item_amount:@item_amount}
				
			when 3
				@@total_amount+=200*@item_quantity
				@item_amount=200*@item_quantity
				puts "Your total amount for Doll is: "+@item_amount.to_s
				@@bill << { i_category: "Toys",item_name: "Doll", item_quantity: @item_quantity,item_amount:@item_amount}
	 ...
	 def farniture_product()
		...
		case @item_number.to_i
			when 1
				...
				@@bill << { i_category: "FARNITURE",item_name: "SOFA", item_quantity: @item_quantity,item_amount:@item_amount}
			when 2
				@@total_amount+=9000*@item_quantity
   				@item_amount=9000*@item_quantity;
				puts "Your total amount for BED is: "+@item_amount.to_s
				@@bill << { i_category: "FARNITURE",item_name: "BED", item_quantity: @item_quantity,item_amount:@item_amount}
			...
			when 3
				...
				@@bill << { i_category: "FARNITURE",item_name: "DRESSING TABLE", item_quantity: @item_quantity,item_amount:@item_amount}
    ...
    def	clothing_products()
		...
		case @item_number.to_i
			when 1
				...
				@@bill << { i_category: "CLOTHING",item_name: "JEANS", item_quantity: @item_quantity,item_amount:@item_amount}
			...
			when 2
				...
				@@bill << { i_category: "CLOTHING",item_name: "TOP", item_quantity: @item_quantity,item_amount:@item_amount}
			...
			when 3
				...
				@@bill << { i_category: "CLOTHING",item_name: "DRESS", item_quantity: @item_quantity,item_amount:@item_amount}
			else
				puts "INVALID!!!please try again"
				@clothing_products
	...
	def bill()
		...
		@@bill.each do |item|
			...
			puts "#{item[:i_category]}\t\t#{item[:item_name]}\t\t#{item[:item_quantity]}\t\t#{item[:item_amount]}"
